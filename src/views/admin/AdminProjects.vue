    ...
    <GlassCard variant="dark" :animated="true">
      <div class="flex flex-col sm:flex-row gap-4">
        ...
        >
          ...
          <option v-for="cat in projectsStore.categories" :key="cat" :value="cat">{{ cat }}</option>
        </select>
        <select 
      ...
      >
        ...
        <div class="relative aspect-video -mx-6 -mt-6 mb-4 overflow-hidden">
          ...
          <div class="absolute top-3 right-3">
            <span 
              ...
              :class="project.is_active ? 'bg-green-500/20 text-green-400 border border-green-500/30' : 'bg-gray-500/20 text-gray-400 border border-gray-500/30'"
            >
              <span class="w-1.5 h-1.5 rounded-full" :class="project.is_active ? 'bg-green-400 animate-pulse' : 'bg-gray-400'"></span>
        ...
        <div class="space-y-3">
          <div>
            ...
            <h3 class="font-semibold text-white text-lg line-clamp-1">{{ project.title }}</h3>
            <p class="text-gray-400 text-sm line-clamp-2 mt-1">{{ project.description }}</p>
          </div>
          ...
          <div class="flex items-center gap-2 pt-3 border-t border-white/10">
            <button 
              ...
              :class="project.is_active ? 'bg-green-500/10 text-green-400 hover:bg-green-500/20' : 'bg-gray-500/10 text-gray-400 hover:bg-gray-500/20'"
            >
