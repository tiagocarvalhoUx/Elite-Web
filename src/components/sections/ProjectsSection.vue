    ...
    <div class="container-futuristic relative z-10">
      ...
      <div class="text-center mb-16">
        ...
        <p class="text-gray-400 text-lg max-w-2xl mx-auto">
          Explore nossa coleção de projetos inovadores que transformaram ideias em realidade digital
        </p>
      </div>
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        >
          <div class="relative overflow-hidden">
            ...
            <!-- Hover overlay -->
            <div class="absolute inset-0 bg-purple-600/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center">
              <span class="px-4 py-2 rounded-full bg-white/10 backdrop-blur-sm text-white text-sm font-medium">
                Ver projeto
              </span>
            </div>
          </div>
          ...
          <div class="p-4">
            <h3 class="text-white font-semibold group-hover:text-purple-400 transition-colors">{{ project.alt }}</h3>
          </div>
        </a>
      </div>
...
const whatsappLink = computed(() => {
  const message = 'Olá! Gostaria de iniciar um projeto com vocês. Vi o portfólio no site e me interessei pelos serviços.'
